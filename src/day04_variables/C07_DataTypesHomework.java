...
public class C07_DataTypesHomework {
    public static void main(String[] args) {
        ...
        boolean ifValue01 = 2 < 3;
        System.out.println("ifValue01 = " + ifValue01);
        System.out.println("------------------");
        ...
        boolean ifValue02 = 2 > 3;
        System.out.println("ifValue02 = " + ifValue02);
        System.out.println("------------------");
        ...
        int intNegative=-6500;
        System.out.println("intNegative = " + intNegative);
        System.out.println("-----------------");
        ...
        short shortNegative=-100;
        System.out.println("shortNegative = " + shortNegative);
        System.out.println("-----------------");
