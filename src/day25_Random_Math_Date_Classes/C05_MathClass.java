...
public class C05_MathClass {
    public static void main(String[] args) {
        ...
        System.out.println("Math.floor(9.8) = " + Math.floor(9.9));  //9

        double pi = Math.PI; //3.141592653589793
        System.out.println("pi = " + pi);  // 22/7

        System.out.println("Math.abs(-3) = " + Math.abs(-3)); //3
        System.out.println("Math.abs(3) = " + Math.abs(3)); //3

        System.out.println("Math.max(50,28) = " + Math.max(50, 28)); // 50
        System.out.println("Math.min(50,28) = " + Math.min(50, 28)); // 50
        ...
        System.out.println("Math.random() = " + Math.random());  // 0.7329839965926306
