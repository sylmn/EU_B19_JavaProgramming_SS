...
public class C07_DateTimeClass {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        Date date1 = new Date();
        System.out.println("date.getTime() = " + date.getTime());  // 1 Ocak 1970'den bu yana geçen saniye
        ...
        System.out.println("tarih.getMonth() = " + tarih.getMonth()); // hangi ay
        ...
        System.out.println("zaman3.compareTo(zaman) = " + zaman3.compareTo(zaman)); // önce olunca 1 sonra olunca -1 aynıı olunca 0
